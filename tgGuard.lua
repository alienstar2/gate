...
day = 86400
--*********BOT ID*******--
BOTS = 385035750 --[[Enter cli bot id here]]
bot_id = 385035750 --[[Enter cli bot id here]]
bot_owner = 383187379 --[[Enter your id here]]
sudo_users = {383187379,385035750,000000000,000000000,000000000} --[[Enter your Id and cli bot Id here]]
--***********************--
-----------------------------------------------------------------------------------------------
---------------
-- Start Functions --
...
-----------------------------------------------------------------------------------------------
function is_bot(msg)
  if tonumber(BOTS) == 385035750 then  --[[Enter your api bot id here]]
    return true
    else
    return false
    end
  ...
  if (data.ID == "UpdateNewMessage") then
    ...
    elseif msg_type == 'MSG:Text' then
	 ...
	 ---------------------------------------------------
      ...
      bot_user_id_ = 385035750,  --[[enter api bot id here]]
      chat_id_ = msg.chat_id_,
      user_location_ = {
        ID = "Location",
        latitude_ = 0,
